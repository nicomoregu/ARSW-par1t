...
2. En el archivo de respuestas indique: hay condiciones de carrera en alguna parte de la aplicación?. Si es así, en qué clase y en qué líneas de código está la región crítica?.
